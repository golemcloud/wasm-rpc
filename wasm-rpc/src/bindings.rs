                      ...
                      match l11 {
                        0 => {
                          let e = {
                              ...
                              let e56 = {
                                ...
                                let v55 = match l14 {
                                  ...
                                  20 => {
                                    ...
                                    WitNode::PrimString(e55)
                                  }
                                  n => {
                                    debug_assert_eq!(n, 21, "invalid enum discriminant");
                                    let e55 = {
                                      let l54 = *((base + 8) as *const i64);
                            ...
                            wit_bindgen::rt::dealloc(base56, (len56 as usize) * 24, 8);
                        ...
                        1 => {
                          let e = {
                            let l57 = i32::from(*((ptr10 + 4) as *const u8));
                            let v70 = match l57 {
                              0 => {
                                let e70 = {
                                  let l58 = *((ptr10 + 8) as *const i32);
                                  let l59 = *((ptr10 + 12) as *const i32);
                                  let len60 = l59 as usize;
                                  let bytes60 = Vec::from_raw_parts(l58 as *mut _, len60, len60);
                                  
                                  wit_bindgen::rt::string_lift(bytes60)
                                };
                                RpcError::ProtocolError(e70)
                              }
                              1 => {
                                let e70 = {
                                  let l61 = *((ptr10 + 8) as *const i32);
                                  let l62 = *((ptr10 + 12) as *const i32);
